      ...
      >
        ...
        <div className="border-t border-[#dee1e6] p-4 w-full flex flex-col gap-1">
          <button
            ...
            className="flex w-full items-center gap-3 px-4 py-3 rounded-lg bg-[#f0f7ff] transition-colors"
          >
            <span className="font-inter text-sm font-medium text-[#1f8cf9]">Налаштування</span>
          </button>
          <button
            type="button"
