...
# ── Email Configuration ───────────────────────────────────────
# Default: console backend for development (set EMAIL_BACKEND=smtp in .env for production)
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', EMAIL_HOST_USER or 'noreply@learnyx.com')
